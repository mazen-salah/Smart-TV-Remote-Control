...
android {
    signingConfigs {
        ...
        // (the maintainer's machine). Forks and CI build with the debug key.
        if (keystorePropertiesFile.exists()) {
            create("release") {
    ...
    namespace = "com.summationworks.smarttvremote"
    ...
    defaultConfig {
        applicationId = "com.summationworks.smarttvremote"
